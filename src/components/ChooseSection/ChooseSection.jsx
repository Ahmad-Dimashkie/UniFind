  ...
  return (
    <div>
        <div className="container">
            <h2 className='text-center mb-5'>Why choose UniFind?</h2>
                    ...
                    <Card className='d-flex align-items-center border-0 h-100'>
                        ...
                        <Card.Body>
                            ...
                            <Card.Text className='text-center'>
                                UniFind offers detailed information about universities, including majors, campus locations, tuition fees, and more, helping you make an informed decision.
                            </Card.Text>
                        </Card.Body>
                    </Card>
                </div>
                <div className='col-lg-4'>
                    <Card className='d-flex align-items-center border-0 h-100'>
                        ...
                        <Card.Body>
                            ...
                            <Card.Text className='text-center'>
                                Our platform is designed to be user-friendly, ensuring that students can easily find and compare universities based on their preferences.
                            </Card.Text>
                        </Card.Body>
                    </Card>
                </div>
                <div className='col-lg-4'>
                    <Card className='d-flex align-items-center border-0 h-100'>
                        ...
                        <Card.Body>
                            ...
                            <Card.Text className='text-center'>
                                UniFind covers universities across Lebanon, providing comprehensive data to help you find the best institution, regardless of location.
                            </Card.Text>
                        </Card.Body>
                    </Card>
                </div>
